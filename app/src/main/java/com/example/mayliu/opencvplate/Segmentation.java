    ...
    String recognizeCharsInPlate(Mat imgThresh,ArrayList<PossibleChar> vectorOfMatchingChars) {
        ...
        for (int i=0;i<vectorOfMatchingChars.size();i++) {
            ...
            if(vectorOfMatchingChars.size()==6){
                if(i==0) {
                    if (vectorOfMatchingChars.get(i + 1).boundingRect.x - vectorOfMatchingChars.get(i).boundingRect.x > 2 * (vectorOfMatchingChars.get(i + 2).boundingRect.x - vectorOfMatchingChars.get(i + 1).boundingRect.x)) {
                        Imgproc.rectangle(imgThreshColor, new Point(vectorOfMatchingChars.get(i + 1).boundingRect.x - 3 * vectorOfMatchingChars.get(i + 1).boundingRect.width, vectorOfMatchingChars.get(i + 1).boundingRect.y), new Point(vectorOfMatchingChars.get(i + 1).boundingRect.x + vectorOfMatchingChars.get(i + 1).boundingRect.width - 3 * vectorOfMatchingChars.get(i + 1).boundingRect.width, vectorOfMatchingChars.get(i + 1).boundingRect.y + vectorOfMatchingChars.get(i + 1).boundingRect.height), new Scalar(0, 255, 0), 5);

                        Rect rect = new Rect((int) Math.pow(vectorOfMatchingChars.get(i + 1).boundingRect.x - 3 * vectorOfMatchingChars.get(i + 1).boundingRect.width, 1), vectorOfMatchingChars.get(i + 1).boundingRect.y, (int) Math.pow(1.05 * vectorOfMatchingChars.get(i + 1).boundingRect.width, 1), vectorOfMatchingChars.get(i + 1).boundingRect.height);
                        ...
                        Imgproc.rectangle(imgThreshColor, new Point(vectorOfMatchingChars.get(i+1).boundingRect.x - 2 * vectorOfMatchingChars.get(i+1).boundingRect.width, vectorOfMatchingChars.get(i+1).boundingRect.y), new Point(vectorOfMatchingChars.get(i+1).boundingRect.x + vectorOfMatchingChars.get(i+1).boundingRect.width - 2 * vectorOfMatchingChars.get(i+1).boundingRect.width, vectorOfMatchingChars.get(i+1).boundingRect.y + vectorOfMatchingChars.get(i+1).boundingRect.height), new Scalar(0, 255, 0), 5);

                        Rect rect1 = new Rect((int) Math.pow(vectorOfMatchingChars.get(i+1).boundingRect.x - 2 * vectorOfMatchingChars.get(i+1).boundingRect.width, 1), vectorOfMatchingChars.get(i+1).boundingRect.y, (int) Math.pow(1 * vectorOfMatchingChars.get(i+1).boundingRect.width, 1), vectorOfMatchingChars.get(i+1).boundingRect.height);
                        //  System.out.println(currentChar.boundingRect.x + " " + currentChar.boundingRect.y + " " + currentChar.boundingRect.width + " " + currentChar.boundingRect.height);
                        Mat test1 = imgThreshColor.submat(rect1);
                        imgCropped.add(test1);


                    } else {
                        Imgproc.rectangle(imgThreshColor, new Point(vectorOfMatchingChars.get(i).boundingRect.x - 1.25 * vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.y), new Point(vectorOfMatchingChars.get(i).boundingRect.x + vectorOfMatchingChars.get(i).boundingRect.width - 1.2 * vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.y + vectorOfMatchingChars.get(i).boundingRect.height), new Scalar(0, 255, 0), 5);

                        Rect rect = new Rect((int) Math.pow(vectorOfMatchingChars.get(i).boundingRect.x - 1.25 * vectorOfMatchingChars.get(i).boundingRect.width, 1), vectorOfMatchingChars.get(i).boundingRect.y, (int) Math.pow(1.05 * vectorOfMatchingChars.get(i).boundingRect.width, 1), vectorOfMatchingChars.get(i).boundingRect.height);
                        //  System.out.println(currentChar.boundingRect.x + " " + currentChar.boundingRect.y + " " + currentChar.boundingRect.width + " " + currentChar.boundingRect.height);
                        Mat test = imgThreshColor.submat(rect);
                        imgCropped.add(test);

                        Imgproc.rectangle(imgThreshColor, new Point(vectorOfMatchingChars.get(i).boundingRect.x, vectorOfMatchingChars.get(i).boundingRect.y), new Point(vectorOfMatchingChars.get(i).boundingRect.x + vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.y + vectorOfMatchingChars.get(i).boundingRect.height), new Scalar(0, 255, 0), 5);
                        Rect rect2 = new Rect(vectorOfMatchingChars.get(i).boundingRect.x, vectorOfMatchingChars.get(i).boundingRect.y, vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.height);
                        System.out.println(vectorOfMatchingChars.get(i).boundingRect.x + " " + vectorOfMatchingChars.get(i).boundingRect.y + " " + vectorOfMatchingChars.get(i).boundingRect.width + " " + vectorOfMatchingChars.get(i).boundingRect.height);
            ...
            else if(vectorOfMatchingChars.size()==7){
                if(i==0) continue;
                else if(i==1){
                    Imgproc.rectangle(imgThreshColor, new Point(vectorOfMatchingChars.get(i).boundingRect.x - 1.25 * vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.y), new Point(vectorOfMatchingChars.get(i).boundingRect.x + vectorOfMatchingChars.get(i).boundingRect.width - 1.2 * vectorOfMatchingChars.get(i).boundingRect.width, vectorOfMatchingChars.get(i).boundingRect.y + vectorOfMatchingChars.get(i).boundingRect.height), new Scalar(0, 255, 0), 5);
